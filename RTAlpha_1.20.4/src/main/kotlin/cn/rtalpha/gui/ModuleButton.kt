...
class ModuleButton(var module: Module,var x: Int,var y: Int) {
    ...
    fun render(context: DrawContext?, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.fill(x,y,x + width,y + if(module.enabled) height else 0,Color(0,255,0,255).rgb)
        context.drawText(MinecraftClient.getInstance().textRenderer,module.name,x + 3,y + 3,Color(0,255,0,220).rgb,true)
    }
